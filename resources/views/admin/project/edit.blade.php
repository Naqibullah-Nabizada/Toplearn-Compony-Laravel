...
@section('content')
    <div class="dynamic col-6 mx-auto text-white">
        ...
        <div>
            <img src="{{ asset('back/images/project/'.$project->image) }}" alt="Project" width="100">
        </div>
        ...
        <input type="submit" value="ویرایش پروژه" class="btn btn-warning mb-5">
